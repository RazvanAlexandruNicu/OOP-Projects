...
public class mv implements Command{
    ...
    private static mv single_instance = null;
    String sourcePath;
    ...
    public void execute() {
        ...
        {
            error.println("mv: cannot move "+this.sourcePath+": No such file or directory");
            return;
        }
        ...
        {
            error.println("mv: cannot move into "+this.destinationPath+": No such directory");
            return;
        }
        if(destination.findChild(source.getName()) == 1)
        {
            error.println("mv: cannot move "+this.sourcePath+": Node exists at destination");
            return;
        
        }
        if(source.getParent() != null)
        {
            Directory pointer = source.getParent();
        ...
        {
    //        System.out.println("Nu pot muta ROOT-ul");
        }
    }
